...
<img src="./src/assets/icon/favicon.png" width="100" alt="4movie logo">
...
- Você possui o `Ionic CLI` instalado globalmente.
...
Para instalar o 4Movie, siga estas etapas:
...
## ☕ Usando 4Movie
Para iniciar o aplicativo no navegador (ambiente de desenvolvimento), execute:
```
ionic serve
```
...
<table>
  ...
  <td align="center">
   ...
   <td align="center">
      <a href="https://github.com/Igor-Silva99" title="José Igor Nascimento">
        <img src="https://github.com/Igor-Silva99.png" width="100px;" alt="Foto do Igor"/><br>
        <sub><b>José Igor Nascimento da Silva</b></sub>
      </a>
    </td>
